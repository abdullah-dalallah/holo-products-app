          ...
          child: Container(
              ...
              child: Scaffold(
                  ...
                  appBar: AppBar(
                    ...
                    centerTitle: false,
                    title: BasicTextWidget(text: translation(context).settings, fontWeight: ConstFontWeights.semiBold, fontSize: ConstDimensions.semiBold16, color: MyColors.grey900),
                    actions: [
